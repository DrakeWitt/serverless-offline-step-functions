    ...
    whatToRun(stateInfo, input, outputKey, callback) {
        switch(stateInfo.Type) {
            case 'Task':
                ...
                // const context = ;
                let runner = `const context = require('${process.cwd()}/node_modules/serverless-offline-step-functions/node_modules/serverless-offline/src/createLambdaContext')(require('${this.getWebpackOrCommonFuction(handlerSplit[0])}').${handlerSplit[1]}, ${callback}); `;
