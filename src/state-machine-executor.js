    ...
    whatToRun(stateInfo, input, outputKey, callback) {
        switch(stateInfo.Type) {
            case 'Task':
                ...
                // const context = ;
                // let runner = `const context = require('${path.relative(process.cwd(), path.resolve(__dirname, '../node_modules/serverless-offline-step-functions/node_modules/serverless-offline/src/createLambdaContext'))}')(require('${this.getWebpackOrCommonFuction(handlerSplit[0])}').${handlerSplit[1]}, ${callback}); `;
